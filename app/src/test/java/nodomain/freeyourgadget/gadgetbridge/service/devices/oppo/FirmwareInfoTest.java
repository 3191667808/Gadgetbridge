...
public class FirmwareInfoTest extends TestBase {
    private static final FirmwareInfo firmwareInfo = new FirmwareInfo(GBApplication.getContext());

    @Test
    public void testHandleFirmware() {
        List<GBDeviceEvent> oppoEvents = firmwareInfo.decode(GB.hexStringToByteArray(
        ...
        List<GBDeviceEvent> air2Events = firmwareInfo.decode(GB.hexStringToByteArray(
        ...
        List<GBDeviceEvent> realme = firmwareInfo.decode(GB.hexStringToByteArray(
                "0003312c322c312e312e302e37352c322c322c312e312e302e37352c332c322c303031"));
