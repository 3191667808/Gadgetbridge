...
/**
 * Security negotiation (service 0x01 / command 0x33) for Huawei devices. Honor PAKE devices use the
 * MBB auth-type variant of the request instead - see GetHonorSecurityNegotiationRequest.
 */
