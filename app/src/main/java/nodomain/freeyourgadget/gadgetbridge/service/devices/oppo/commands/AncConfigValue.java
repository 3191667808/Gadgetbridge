...
public enum AncConfigValue implements LabeledEntry {
    ...
    @Nullable
    public static AncConfigValue fromPreference(final String value) {
        for (final AncConfigValue param : AncConfigValue.values()) {
    ...
    public static EnumSet<AncConfigValue> fromPreferences(@NonNull Set<String> values) {
        EnumSet<AncConfigValue> result = EnumSet.noneOf(AncConfigValue.class);
        for (String value : values) {
            AncConfigValue mode = fromPreference(value);
            if (mode != null) {
                result.add(mode);
            }
        }
    ...
    public static Set<String> toPreferences(final EnumSet<AncConfigValue> values) {
