...
/**
 * Protocol implementation for EarFun Air Pro 3 (TW500)
 */
public class EarFunAirPro3Protocol extends EarFunProtocol {

    private static final Logger LOG = LoggerFactory.getLogger(EarFunAirPro3Protocol.class);
    ...
    protected EarFunAirPro3Protocol(GBDevice device) {
        super(device);
        DeviceType type = device.getType();
        LOG.debug("Initialized EarFunAirPro3Protocol for device: {}", type);
    }
}
