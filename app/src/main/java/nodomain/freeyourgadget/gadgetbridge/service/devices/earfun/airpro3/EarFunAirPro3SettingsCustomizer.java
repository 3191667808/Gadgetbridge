...
/**
 * Settings customizer for EarFun Air Pro 3 (TW500)
 */
public class EarFunAirPro3SettingsCustomizer extends EarFunSettingsCustomizer {
    ...
    public void onPreferenceChange(Preference preference, DeviceSpecificSettingsHandler handler) {
        ...
        switch (key) {
            case PREF_EARFUN_AMBIENT_SOUND_CONTROL:
                // Update visibility of ANC/transparency mode settings based on selected mode
    ...
    public EarFunAirPro3SettingsCustomizer(final GBDevice device) {
        super(device);
    }
}
