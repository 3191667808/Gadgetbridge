...
public enum PayloadTypeV2 {
    ...
    PERIPHERAL_STATUS_GET(MessageType.COMMAND_2, 0x32),
    PERIPHERAL_STATUS_RET(MessageType.COMMAND_2, 0x33),
    PERIPHERAL_STATUS_SET(MessageType.COMMAND_2, 0x34),
    PERIPHERAL_STATUS_NOTIFY(MessageType.COMMAND_2, 0x35),

    PERIPHERAL_DEVICES_GET(MessageType.COMMAND_2, 0x36),
    PERIPHERAL_DEVICES_RET(MessageType.COMMAND_2, 0x37),
    PERIPHERAL_PARAMETER_SET(MessageType.COMMAND_2, 0x38),
    PERIPHERAL_DEVICES_NOTIFY(MessageType.COMMAND_2, 0x39),

    PERIPHERAL_CONNECTION_SET(MessageType.COMMAND_2, 0x3c),
    PERIPHERAL_CONNECTION_NOTIFY(MessageType.COMMAND_2, 0x3d),
    ...
    SERVICE_LINK_GET(MessageType.COMMAND_1, 0xb6),
    SERVICE_LINK_RET(MessageType.COMMAND_1, 0xb7),
    SERVICE_LINK_SET(MessageType.COMMAND_1, 0xb8),
    SERVICE_LINK_NOTIFY(MessageType.COMMAND_1, 0xb9),

    FACTORY_RESET_SET(MessageType.COMMAND_1, 0xf8),
