...
public class MeasureLiveAppStatus extends WithingsStructure {
    private short value;

    public MeasureLiveAppStatus() {
    }

    public MeasureLiveAppStatus(final int value) {
