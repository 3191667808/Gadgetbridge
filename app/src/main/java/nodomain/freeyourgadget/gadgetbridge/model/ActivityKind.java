...
public enum ActivityKind {
    ...
    FREE_DIVING(0x04000110, R.string.activity_type_free_diving),
    REC_SCUBA_DIVING(0x04000112, R.string.activity_type_rec_scuba_diving),
    TECH_SCUBA_DIVING(0x04000113, R.string.activity_type_tech_scuba_diving),
    ;
