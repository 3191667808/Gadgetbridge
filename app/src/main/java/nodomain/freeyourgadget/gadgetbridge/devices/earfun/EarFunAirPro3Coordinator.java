...
import nodomain.freeyourgadget.gadgetbridge.service.devices.earfun.airpro3.EarFunAirPro3DeviceSupport;
import nodomain.freeyourgadget.gadgetbridge.service.devices.earfun.airpro3.EarFunAirPro3SettingsCustomizer;

/**
 * Device coordinator for EarFun Air Pro 3 (TW500)
 */
public class EarFunAirPro3Coordinator extends AbstractEarFunCoordinator {
    @Override
    public int getDeviceNameResource() {
        return R.string.devicetype_earfun_air_pro_3;
    }

    @Override
    public boolean supports(GBDeviceCandidate candidate) {
        if (candidate.getName().startsWith("EarFun Air Pro 3")) {
            return true;
        }
        ...
        String[] uuids = {
                ...
                "0000eb04-d102-11e1-9b23-00025b00a5a5",  // Qualcomm proprietary
                "0000eb06-d102-11e1-9b23-00025b00a5a5",  // Qualcomm proprietary
                "0000eb07-d102-11e1-9b23-00025b00a5a5",  // Qualcomm proprietary
                "0000eb05-d102-11e1-9b23-00025b00a5a5",  // Qualcomm proprietary
                "df21fe2c-2515-4fdb-8886-f12c4d67927c",  // Custom service
    ...
    public Class<? extends DeviceSupport> getDeviceSupportClass(final GBDevice device) {
        return EarFunAirPro3DeviceSupport.class;
    }
    ...
    public DeviceSpecificSettings getDeviceSpecificSettings(final GBDevice device) {
        ...
        deviceSpecificSettings.addRootScreen(R.xml.devicesettings_earfun_air_pro_3_sound_control);

        // Category Audio Quality & Connectivity
        deviceSpecificSettings.addRootScreen(R.xml.devicesettings_earfun_header_connectivity);
        deviceSpecificSettings.addRootScreen(R.xml.devicesettings_earfun_air_pro_3_audio_quality);

        // Category System Settings
        deviceSpecificSettings.addRootScreen(R.xml.devicesettings_earfun_header_system_settings);
        deviceSpecificSettings.addRootScreen(R.xml.devicesettings_earfun_air_pro_3_gestures);
    ...
    public DeviceSpecificSettingsCustomizer getDeviceSpecificSettingsCustomizer(final GBDevice device) {
        return new EarFunAirPro3SettingsCustomizer(device);
    }
}
