    ...
    override fun getDeviceSettings(device: GBDevice): DeviceSettingsSpec = deviceSettings {
        ...
        screen(
            ...
            action(
                ...
                onClick = { handler ->
                    handler.notifyPreferenceChanged(SonyReonPocketConstants.ACTION_REGISTER_TAG)
                    true
                },
            )
            action(
                ...
                onClick = { handler ->
                    handler.notifyPreferenceChanged(SonyReonPocketConstants.ACTION_UNREGISTER_TAG)
                    true
                },
            )
            info(
