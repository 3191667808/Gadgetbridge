...
public class WearFitCoordinator extends AbstractBLEDeviceCoordinator {

    public static final int FindPhone_ON = -1;
    public static final int FindPhone_OFF = 0;

    private static final Logger LOG = LoggerFactory.getLogger(WearFitCoordinator.class);
    ...
    public static boolean getQuietHours(SharedPreferences sharedPrefs, Calendar startOut, Calendar endOut) {
        ...
        if (doNotDisturb.equals(getContext().getString(R.string.p_off))) {
            ...
            try {
                ...
                LOG.error("Unexpected exception in WearFitCoordinator.getTime: " + e.getMessage());
                return false;
            }
        }
    }
